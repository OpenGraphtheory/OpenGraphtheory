...
#line 109 "ml_parser.hpp"
   ...
   enum yytokentype {
    ...
    MLParser (OpenGraphtheory::Logic::MLLexer &scanner_yyarg, OpenGraphtheory::Logic::MLFormula** result_yyarg);
    virtual ~MLParser ();
  ...
  private:
    ...
    /* User arguments.  */
    OpenGraphtheory::Logic::MLLexer &scanner;
    OpenGraphtheory::Logic::MLFormula** result;
  };
