...
#line 109 "ctl_parser.hpp"
   ...
   enum yytokentype {
    ...
    CTLParser (OpenGraphtheory::Logic::CTLLexer &scanner_yyarg, OpenGraphtheory::Logic::CTLFormula** result_yyarg);
    virtual ~CTLParser ();
  ...
  private:
    ...
    /* User arguments.  */
    OpenGraphtheory::Logic::CTLLexer &scanner;
    OpenGraphtheory::Logic::CTLFormula** result;
  };
